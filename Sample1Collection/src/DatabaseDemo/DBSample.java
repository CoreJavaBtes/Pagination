...
public class DBSample {
	...
	void insert(String name, String email, String contact, String pass, String add)
	{
	  
	       
        try {
            PreparedStatement pd = con.prepareStatement("Insert into tb_test (name,email,contact,password,address) values(?,?,?,?,?) ");
	...
	{
		try {
            PreparedStatement pd = con.prepareStatement("select * from tb_test where email = '"+uname+"' and password = '"+pass+"' ");
	...
	public static void main(String[] args) {
		...
		case 1:
			...
			obj.insert(name, email, cont, pass, add);
			break;
